...
export const Header = () => {
  return (
    <header className='sticky top-0 flex  h-20 w-full items-center justify-between gap-4 bg-white/10 px-10 text-white shadow-md  backdrop-blur  max-md:h-16 max-md:px-2 '>
      <div className='  flex  h-full items-center  gap-3  '>
        <Link href='/home' className='max-md:scale-75'>
